<x-storefront-layout :title="$product->seo_title ?: $product->title" :description="$product->meta_description ?: $product->short_description" :image="$product->featured_image_path" og-type="product">
    @php
